public class MessageModel {
    ...
    public static final int CHANGE_USER_TYPE = 12;
    public static final int CHANGE_USER_PASSWORD = 13;
    ...
    public static final int PUT_PURCHACE = 301;

    public static final int GET_PURCHASE_LIST = 500;

    public static final int SEARCH_PRODUCT = 600;

    public static final int LOAD_PURCHASE_SUMMARY = 400;
